// Copyright Mike Kenyon (c) 2012. All rights reserved.
...
function showLinks() {
	...
	while (linksTable.children.length > 1) {
		linksTable.removeChild(linksTable.children[lnksTable.children.length - 1])
	}
...
// Add links to allLinks and visibleLinks, sort and show them.
...
// Set up event handlers and inject send_links.js 
// into all frames in the active tab.
